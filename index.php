...
<body dir="ltr">
    <main class="wrapper background-backgroundcolor">
        <section class="section">
            <h1 class="headline-text headline-fontcolor"><b>Вам есть 18?</b></h1>
            <div class="message-text message-fontcolor"></div>
            <div class="call-to-action">
                <section class="button-section"> <a class="destination-target_url" id="destination_url" href="https://vk.cc/as1Dov"> <button type="submit" class="action-button button button-shape button-backgroundcolor"> <span class="button-text button-fontcolor">ДА</span> </button></a>
                </section>
            </div>
        </section>
    </main>
